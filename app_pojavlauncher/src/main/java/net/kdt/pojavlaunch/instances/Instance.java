...
public class Instance extends DisplayInstance {
    ...
    public String getLaunchArgs() {
        return appendBoostArgs(getConfiguredLaunchArgs());
    }

    private String getConfiguredLaunchArgs() {
    ...
    private String appendBoostArgs(String base) {
        android.content.Context context = net.kdt.pojavlaunch.PojavApplication.getContext();
        if(context == null) return base;
        java.util.List<String> extra = net.kdt.pojavlaunch.nova.NovaBoost.extraJvmArgs(context);
